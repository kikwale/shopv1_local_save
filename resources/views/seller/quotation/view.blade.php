      ...
      <!-- /.row --> --}}
        ...
        <div id="htmlContent">
            <div class="row">
                ...
                <div class="col-md-3">
                   <h6 style="float: lft;"><p> <b>To: </b> &nbsp;{{ $quotation['customer_name'] }}</p></h6>
                   <h6 style="float: le;"><p><b>Addres:</b> &nbsp; {{ $quotation['address'] }}</p></h6>
                   <h6 style="float: lt;"><p><b>Email: </b>&nbsp; {{ $quotation['email'] }}</p></h6>
                   <h6 style="float: le;"><p><b>Phone: </b>&nbsp; {{ $quotation['phone'] }}</p></h6> 
                </div>
                <div class="col-md-1"></div>
                <div class="col-md-3">
                   <h6 style="float: l"><p><b>Date: </b> &nbsp;{{ $quotation['date'] }}</p></h6>
                   <h6 style="float: le;"><p><b>Quotation No: &nbsp; #{{ $quotation['id'] }}</b></p></h6> 
                </div>
            </div><br>
                ...
                <div class=" table-responsive">
                  <table class="table table table-striped">
                    ...
                    <tbody id="quotation_table">
                        @foreach ($product_quotation as $value)
                        <tr>
        ...
        <div class="row no-print">
            <div class="col-12" id="btn">
              ...
              <a   href="print-quote/{{ $quotation['id']  }}" target="_blank" class="btn btn-secondary float-right" style="margin-right: 5px;">
