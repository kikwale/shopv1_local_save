      ...
      <!-- /.row --> --}}
          ...
          <section class="content">
            <div class="container-fluid">
              ...
              @if (session('success2'))
             <div class="alert alert-success alert-dismissible fade show" role="alert">
                  <strong>Ok !! </strong> Successfuly Order accepted.
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              </div>
              @endif

               @if (session('large_quantity'))
               <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong> </strong> {{ session('large_quantity') }}
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                @endif
                                          ...
                                          <div class="card-head">
                                            ...
                                            <div class="card-bod">
                                              ...
                                              <table id="example1" class="table table-bordered table-striped">
                                                <thead>
                                                <tr>
                                                  <th> Shop Placing Order </th>
                                            
                                                  <th>Country</th>
                                                  <th>Region</th>
                                                  <th>Street</th>
                                                  <th>Contact</th>
                                                  <th>Product Placed Order</th>
                                                  <th>Quantity Orederd</th>
                ...
                id	name	owner_id	shop_id	category	unit	quantity	amount	purchased_price	sold_price	expire	created_at	updated_at	
                    --}}
                                        ...
                                        <tr>
                                          ...
                                          <td>{{$value->country}}</td>
                                          <td>{{$value->region}}</td>
                                          <td>{{$value->street}}, &nbsp; {{$value->district}}</td>
                                          <td><a href="tel:+{{$value->seller_Phone}}">{{$value->seller_Phone}}</a> <br><a href="mailto:{{$value->seller_email}}">{{$value->seller_email}}</a></td>
                                          ...
                                          <td>
                                              <a class="btn btn-info btn-sm" href="seller-accept-order?id={{$value->id}}&&ttt@#gfdf$=5hj5hjg$3$$$$$#*^fg">
                                            
                                               Accept
                                               </a>
                                               <a class="btn btn-danger btn-sm" href="seller-reject-order?id={{$value->id}}&&dhfjhdhgfjhgfjdhfhghguh@#gfdf$=5hj5hjg$3$$$$$#*^fg" >
