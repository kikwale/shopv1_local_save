                    ...
                    --}}
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <small class="text-success"> <span class="right badge badge-warning">In Progress</span></small>
                                            @endif
                                            @if ($value->status == 'accepted')
                                            <a class="btn btn-info btn-sm" href="seller-confirm-delivery?id={{ $value->id }}">Confirm Delivery</a>
                                           @endif
                                            @if ($value->status == 'rejected')
                                            <small class="text-success"> <span class="right badge badge-danger">Does not Accepted</span></small>
                                            @endif
                                            @if ($value->status == 'delivered')
                                          
                                               <small> 
                                                <small class="text-success"> <span class="right badge badge-info">Delivered</span></small>
                                            ...
                                            @endif
                                            <br>
                                            <a class="btn btn-dark btn-sm" href="seller-cancel-order?id={{ $value->id}}">Cancel</a>
                                          </td>
