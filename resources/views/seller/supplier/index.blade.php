      ...
      <!-- /.row --> --}}
              ...
              <div class="row mb-2">
                <div class="col-sm-6">
                  ...
                  <h1 class="m-0 text-dark">Customers Dashboard</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                        ...
                                        <div class="car">
                                          <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                              ...
                                              <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#staticBackdrop">  Add Supplier</a>
...
updated_at
                  ...
                  <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="seller-save-supplier">
                                @csrf
  ...
  {{-- date	customer_name	address	email	phone	--}}
                                ...
                                <div class="form-group row">
                                    <label for="supplier_name" class="col-md-4 col-form-label text-md-right">{{ __('Supplier Name') }}</label>

                                    <div class="col-md-6">
                                        <input required id="supplier_name" type="text" class="form-control @error('supplier_name') is-invalid @enderror" name="supplier_name" value="{{ old('supplier_name') }}"  autocomplete="supplier_name" autofocus>
                                ...
                                <div class="form-group row">
                                  <label for="address" class="col-md-4 col-form-label text-md-right"><sup class="text-danger"></sup>{{ __('Location') }}</label>
