                            ...
                            <div class="car">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <a href="" data-toggle="modal" data-target="#loan_from"
                                            class="btn btn-primary">New Loan</a>
...
updated_at --}}
                                            @foreach ($data as $value)
                                                <tr>
                                                    ...
                                                    <td>{{ $value->instalment_payment }}</td>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-info">
                                                                    <h5 class="modal-title" id="staticBackdropLabel">Return
                                                                        Loan From Finencial Institutes</h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST" action="owner-loan-return-modal">
                                                                        @csrf
    ...
    @include('owner/modals.loan_from_modal')
