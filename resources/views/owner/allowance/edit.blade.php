            ...
            <div class="container-fluid">
             ...
             <div class="alert alert-danger alert-dismissible fade show" role="alert">
              ...
              @endif
                ...
                <form method="POST" action="owner-allowance-edit">
                    @csrf
                    ...
                    <input id="allowance_id" type="text" class="form-control @error('allowance_id') is-invalid @enderror" name="allowance_id" value="{{ $allowance->id }}" hidden autocomplete="allowance_id">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select required id="name" type="text" class="select2 form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}"  autocomplete="name">
                              <option value="{{ $allowance->seller_id }}">{{ $allowance->fname }} &nbsp; &nbsp; {{ $allowance->lname }}</option>  
                        ...
                        <div class="col-md-6">
                            ...
                            <input required id="allowance" type="number" class="form-control @error('allowance') is-invalid @enderror" name="allowance" value="{{ $allowance->amount }}"  autocomplete="allowance">
