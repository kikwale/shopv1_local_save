      ...
      <!-- /.row --> --}}
              ...
              <div class="row mb-2">
                <div class="col-sm-6">
                  ...
                  <a href="Loan-from" class="btn btn-primary">BACK</a>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <b>Date:</b> &nbsp; {{ $info->return_date }} <br>
                            <b>Paid Amount:</b> &nbsp; {{ $info->paid_amount }} <br>
                            <b>Payment Method:</b> &nbsp; {{ $info->Payment_method }} <br>
                             @if ($info->Payment_method != 'Cash')
                             <b>Name:</b> &nbsp; {{ $info->method_name }} <br>
